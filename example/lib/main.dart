...
class CodeFieldDemo extends StatelessWidget {
  const CodeFieldDemo({super.key});

  // This widget is the root of your application.
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Flutter Code Field Demo',
      theme: ThemeData(
      ...
      home: const MyHomePage(title: 'Flutter Code Field Demo'),
    );
  }
}
